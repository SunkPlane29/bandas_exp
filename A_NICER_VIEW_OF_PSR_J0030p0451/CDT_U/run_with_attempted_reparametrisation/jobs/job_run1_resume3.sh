...
srun python main_run1_resume3.py > out_run1_resume3 2> err_run1_resume3

cp run1* out_run1_resume3 err_run1_resume3 $HOME/NICER_analyses/J0030_CDTU_reparametrised/.
#end of job file
