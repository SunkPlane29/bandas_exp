...
srun python main_run1.py > out_run1_short_resume1 2> err_run1_short_resume1

cp run1* out_run1_short_resume1 err_run1_short_resume1 $HOME/NICER_analyses/J0030_ST_CST/.
#end of job file
