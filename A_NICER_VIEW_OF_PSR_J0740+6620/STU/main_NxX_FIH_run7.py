""" Main module for NICER x XMM J0740 <- X-PSI v0.7 ST-U. """
...
if __name__ == '__main__':
    ...
    args = parser.parse_args(['@STU/config.ini'])
...
from STU.CustomPhotosphere import CustomPhotosphere
...
if args.XMM:
    ...
    support[:,0] = spectrum - 0.01 * np.sqrt(spectrum)
    support[support[:,0] < 0.0, 0] = 0.0
    support[:,1] = spectrum + 0.01 * np.sqrt(spectrum)
...
#    likelihood.check(None, [-20701.26956], 1.0e-6,
#	             physical_points=[p])
#elif args.XMM:
#    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576  ,
#	  0.66016391,  0.1450841 ,  6.02927387,  0.69387331,  1.54402738,
#	  0.10217615,  6.04285115,  1.0,         0.18888585]
#    likelihood.check(None, [-4564.3852715], 1.0e-6,
#	             physical_points=[p])
#elif args.NICER:
#    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576  ,
#	  0.66016391,  0.1450841 ,  6.02927387,  0.69387331,  1.54402738,
#	  0.10217615,  6.04285115,  1.12881329,  1.0]
#    likelihood.check(None, [-16136.884266], 1.0e-6,
#	             physical_points=[p])
...
if __name__ == '__main__': # sample from the posterior
    ...
    if args.multinest:
        runtime_params = {'resume': args.resume,
                          ...
                          'outputfiles_basename': 'samples/nlive2000_eff0.1_noCONST_noMM_noIS_tol-1',
