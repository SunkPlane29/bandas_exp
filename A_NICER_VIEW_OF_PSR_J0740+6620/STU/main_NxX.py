...
if args.XMM and args.NICER:
    ...
    likelihood.check(None, [-20698.48562775642], 1.0e-6, physical_points=[p])
elif args.XMM:
    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576,
         0.66016391,  0.1450841 ,  6.02927387,  0.69387331 - 1.0,  1.54402738,
         0.10217615,  6.04285115,  1.0,         0.18888585]
    likelihood.check(None, [-4564.3852715], 1.0e-6, physical_points=[p])
elif args.NICER:
    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576,
         0.66016391,  0.1450841 ,  6.02927387,  0.69387331 - 1.0,  1.54402738,
         0.10217615,  6.04285115,  1.12881329,  0.18888585]
    likelihood.check(None, [-16134.100356256422], 1.0e-6, physical_points=[p])
