...
srun python main_run1_resume2.py > out_run1_resume2 2> err_run1_resume2

cp run1* out_run1_resume2 err_run1_resume2 $HOME/NICER_analyses/J0030_CDTU_reparametrised/.
#end of job file
