""" Main module for XMM J0740 <- X-PSI v0.7 ST-U. """
...
parser = argparse.ArgumentParser(
    description='''
    Main module for X-PSI ST-U modelling of XMM J0740+6620 event data.
...
from CustomPrior_GLS import CustomPrior
...
if args.XMM and args.NICER:
    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576  ,
          0.66016391,  0.1450841 ,  6.02927387,  0.69387331 - 1.0,  1.54402738,
          0.10217615,  6.04285115,  1.12881329,  0.18888585,  1.0        ]
    likelihood.check(None, [-20698.48562775642], 1.0e-6,
                     physical_points=[p])
elif args.XMM:
    p = [ 2.05908899, 11.68789646,  1.04426186,  0.04061792, -0.246576  ,
    ...
    likelihood.check(None, [-16134.100356256422], 1.0e-6,
                     physical_points=[p])
