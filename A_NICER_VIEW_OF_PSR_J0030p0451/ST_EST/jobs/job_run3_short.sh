...
srun python main_run3_short.py > out_run3_short 2> err_run3_short

cp run3* out_run3_short err_run3_short $HOME/NICER_analyses/J0030_ST_EST/.
#end of job file
